...
class Feedback {
    constructor(options, html2canvasOptions) {
        ...
        this._drawStop = ($event) => {
            if (this._state.canDraw) {
                ...
                const helper = Object.assign(Object.assign({}, this._area), { highlight: this._state.highlight, index: this._helperIdx++ });
                if (helper.width < 0) {
        ...
        this._addHighlightedElement = ($event) => {
            if (this._highlightedArea) {
                ...
                const helper = Object.assign(Object.assign({}, this._highlightedArea), { highlight: this._state.highlight, index: this._helperIdx++ });
                if (helper.width < 0) {
                    helper.startX += helper.width;
                    helper.width *= -1;
                }
        ...
        if (html2canvasOptions) {
            this._html2canvasOptions = Object.assign(Object.assign({}, this._html2canvasOptions), html2canvasOptions);
        }
    }
    open() {
    ...
    _genScreenshot() {
        this._html2canvasOptions = Object.assign(Object.assign({}, this._html2canvasOptions), { width: window.innerWidth, height: window.innerHeight, scrollX: window.pageXOffset, scrollY: window.pageYOffset, x: window.pageXOffset, y: window.pageYOffset });
